class SoalUas {
  final String SoalUasText;
  final List<Answer> answersList;

  SoalUas(this.SoalUasText, this.answersList);
}
...
List<SoalUas> getSoalUas() {
  List<SoalUas> list = [];

  list.add(SoalUas("Kapan terjadinya perang badr?", [
  ...
  list.add(SoalUas("Perang Uhud berada di sebelah?", [
  ...
  list.add(SoalUas("Berapa jumlah kaum muslimin pada perang Mut'ah?", [
