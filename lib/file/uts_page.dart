...
import 'package:tarikh_islami/model/soal_uts.dart';
...
class _UtsPageState extends State<UtsPage> {
  List<SoalUts> quizList = getSoalUts();
  int currentSoalUtsIndex = 0;
  int score = 0;
  ...
  _quizWidget() {
    return Column(
      ...
      children: [
        ...
        Text(
          "Soal ${currentSoalUtsIndex + 1}/${quizList.length.toString()}",
        ...
        Container(
          ...
          child: Text(
            quizList[currentSoalUtsIndex].SoalUtsText,
  ...
  _answerList() {
    return Column(
      children: quizList[currentSoalUtsIndex]
          .answersList
          .map(
            (e) => _answerButton(e),
          )
  ...
  _nextButton() {
    ...
    if (currentSoalUtsIndex == quizList.length - 1) {
      isLastQuiz = true;
    }
    return Container(
